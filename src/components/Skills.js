  ...
  return (
    <motion.div
      ...
      className="cursor-pointer w-max origin-center absolute 
       font-semibold bg-dark text-light py-3 px-6 rounded-full dark:bg-primaryDark dark:text-dark
...
<>
    ...
    >
        ...
        dark:bg-primaryDark dark:text-dark lg:p-6 md:p-4 xs:text-xs xs:p-2
        ">
        Web
      </motion.div>
        ...
        <Skill name="Typescript" x="8vw" y="21vw" />
    </div></>
  );
};
